<body>
    ...
    <header>
        ...
        <nav class=" mynav navbar navbar-expand-lg ">
            <a class="navbar-brand" href="#"><img src="IMAGES/logo250.png" alt="" style="width: 70px; height:70px; margin-top:-20px;margin-bottom:-20px;margin-left:20px;"></a>
                    ...
                    ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="VIEW/addgame.php">Add a Game</a>
